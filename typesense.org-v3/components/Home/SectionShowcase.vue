...
import CopyThin from "@/assets/icons/copy-thin.svg";
...
.top span {
  @apply text-sm capitalize leading-[1.6] tracking-tight;
}
h5 {
  @apply font-heading text-[20px] capitalize leading-none;
}
.icon-list {
  @apply flex gap-2;
}
