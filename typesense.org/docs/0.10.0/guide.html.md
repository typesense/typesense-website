...
<div class="row no-gutters">
  <div id="doc-col" class="col-md-8">
    ...
    ```shell
      mkdir /tmp/typesense-data
      docker run -p 8108:8108 -v/tmp/typesense-data:/data typesense/typesense:0.10.0 \
    ...
    <p><strong>NOTE:</strong> Command line arguments are given the higest priority, while
    environment variables are given the least priority.</p>
    ...
    ```shell
    ./typesense-server --config=/etc/typesense.ini
    ```
    {% endcode_block %}

    <p>The configuration file uses a simple <a target="_blank" href="https://en.wikipedia.org/wiki/INI_file">INI format</a>
      and here's how it can look like:</p>
    ...
    <p>If you wish to use environment variables, you can do that too.</p>
