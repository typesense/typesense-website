---
title: "Migrate from Algolia to Typesense"
...
| Optional Filtering                                                                                                  | <RouterLink :to="`/${$site.themeConfig.typesenseLatestVersion}/api/search.html#sorting-based-on-conditions`">Sorting Based on Conditions</RouterLink>                                                                                                                                                                                                                                                                                                                                        |
| Filter Scoring                                                                                                      | <RouterLink :to="`/${$site.themeConfig.typesenseLatestVersion}/api/search.html#sorting-based-on-filter-score`">Sorting Based on Filter Score</RouterLink>                                                                                                                                                                                                                                                                                                                                    |
...
| `optionalFilters`                                                                          | <RouterLink :to="`/${$site.themeConfig.typesenseLatestVersion}/api/search.html#sorting-based-on-conditions`">Sorting Based on Conditions</RouterLink>                                                                                                                                                                                                                                                                                                                                                                                                  |
