...
| facet_sample_slope | no       | Controls how steeply we want the `facet_sample_percent` to fall as the collection grows. Useful to make `facet_sample_percent` dynamic as per collection size. If the collection grows beyond sample_threshold, the percentage slides downward on a straight-line “slope”.<br><br>`facet_sample_threshold` should be non-zero for `facet_sample_slope` to be effective.
<br><br>Default: `0`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
NOTE: Referenced faceting can be done on joined collection only in the query.
