<template>
  <div class="container">
    ...
    <div class="text-center">Neatly wrapped in a RESTful API</div>
    ...
    return {
      features: [
        ...
        },
        {
          ...
          icon: require('~/assets/images/synonyms_icon.svg'),
        },
        {
          ...
          icon: require('~/assets/images/api_keys_icon.svg'),
        },
        {
          ...
          icon: require('~/assets/images/sorting_icon.svg'),
        },
        {
